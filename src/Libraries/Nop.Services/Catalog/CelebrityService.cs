...
namespace Nop.Services.Catalog
{
    public class CelebrityService : ICelebrityService
    {
        ...
        public CelebrityService(CatalogSettings catalogSettings, IRepository<Celebrity> celebrityRepository, IEventPublisher eventPublisher, ICacheKeyService cacheKeyService,
        ...
        public virtual IPagedList<Celebrity> SearchCelebrities(
            ...
            int languageId = 0,
            CelebritySortingEnum orderBy = CelebritySortingEnum.Position
)
        {
            //search by keyword
